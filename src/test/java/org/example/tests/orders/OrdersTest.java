...
//    @Test(priority = 5, description = "Kiểm tra xử lý lỗi khi không có token")
//    public void testErrorHandlingWithoutToken() {
...
//        slowDown(1000);
//
//        // Kiểm tra đã chuyển hướng về trang chủ
//        Assert.assertTrue(driver.getCurrentUrl().contains("home.html"),
//                "Không chuyển hướng về trang chủ khi không có token");
//
//        // Đăng nhập lại để tiếp tục các test khác nếu cần
//        loginHelper.login("nguyendatthcspv@gmail.com", "1234567");
//        slowDown(1000);
//    }

//    @Test(priority = 6, description = "Kiểm tra chức năng đăng xuất")
...
//        slowDown(1000);
//
//        // Kiểm tra đã chuyển hướng về trang chủ/đăng nhập
//        Assert.assertTrue(driver.getCurrentUrl().contains("home.html"),
//                "Không chuyển hướng về trang chủ sau khi đăng xuất");
//
//        // Kiểm tra token đã bị xóa
//        Object token = driver.executeScript("return localStorage.getItem('token');");
//        Assert.assertNull(token, "Token không bị xóa sau khi đăng xuất");
//    }
